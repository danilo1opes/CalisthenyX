  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 items-center max-w-7xl mx-auto">
        {/* Coluna 1 */}
        <div className="hidden md:grid grid-rows-2 gap-4 md:gap-6 h-[400px] md:h-[500px] lg:h-[600px]">
          ...
          <div className="relative overflow-hidden">
            <Image
              ...
              loading="eager"
              sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
              alt="Mulher fazendo flexão com kettlebell"
            />
          </div>
        </div>

        {/* Coluna 2 */}
        <div className="order-2 md:order-1 relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <Image
            src={'/planche.png'}
            width={500}
            height={600}
            ...
            loading="eager"
            sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"
            alt="Homem demonstrando planche"
          />
        </div>
