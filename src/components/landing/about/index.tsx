  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-[auto_auto_1fr] gap-6 md:gap-8 lg:gap-20 2xl:gap-28 items-start max-w-[1920px] 2xl:mx-auto">
        {/* Image 1 */}
        <figure className="order-2 md:order-2 lg:order-1 w-full md:w-full lg:w-96 2xl:w-[28rem]">
          <Image
            src="/pull.jpg"
            width={500}
            height={500}
            ...
            alt="Homem realizando um exercício de muscle-up em uma barra de calistenia"
          />
          <figcaption className="sr-only">
            Exercício de força realizado em barra — muscle-up.
          </figcaption>
        </figure>

        {/* Image 2*/}
        <figure className="hidden lg:order-2 lg:block w-64 2xl:w-80 ml-8 2xl:ml-12 relative">
          <Image
            src="/forca.jpg"
            width={300}
            height={400}
            ...
            alt="Homem realizando uma barra com apenas um braço"
          />

          {/* Card */}
          <figcaption className="bg-gradient-to-b from-linear-snow to-linear-dark p-2 2xl:p-3 -mt-2 absolute top-65 2xl:top-85 text-center">
