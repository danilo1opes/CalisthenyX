...
export default function AboutUs() {
  return (
    <section aria-labelledby="hero-title" className="px-6 md:px-0 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-[auto_auto_1fr] gap-6 md:gap-20 items-start">
        {/* Image 1 */}
        <div className="order-2 md:order-1 w-full md:w-80 lg:w-96">
          <Image
            src={'/pull.jpg'}
            width={500}
            height={500}
        ...
        <div className="hidden md:order-2 lg:block w-64 lg:w-64 ml-4 lg:ml-8 relative">
          ...
          {/* Card */}
          <div className="bg-gradient-to-b from-linear-snow to-linear-dark p-2 -mt-2 absolute top-65 text-center">
            <h3 className="text-white font-sub font-bold text-base mb-2">
              Treinamento de Força
            </h3>
            <p className="text-body text-xs font-sub">
        ...
        <div className="order-1 md:order-3">
          ...
          <p className="text-snow mt-6 lg:mt-8 font-body antialiased md:text-sm lg:text-xl leading-relaxed">
